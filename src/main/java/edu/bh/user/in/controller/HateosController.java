/*
 * package edu.bh.user.in.controller; import static
 ...
 * 
 * import edu.bh.user.entity.User; import edu.bh.user.service.UserService;
 * 
 * 
 * @RestController
 * 
 * @RequestMapping("/hateos") public class HateosController {
 * 
